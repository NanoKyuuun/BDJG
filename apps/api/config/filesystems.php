    ...
    */
    ...
    'disks' => [
        ...
        'media' => [
            ...
            'url' => rtrim(env('APP_URL', 'http://localhost:8000'), '/').'/api/v1/media-stream',
            'visibility' => 'private',
            'throw' => false,
            'report' => false,
            // S3 / R2 / MinIO cloud configuration parameters when MEDIA_DISK_DRIVER=s3
            ...
            'bucket' => env('MEDIA_AWS_BUCKET', env('AWS_BUCKET', 'bdjg-media')),
